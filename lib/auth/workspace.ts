...
// Single-organization model: each user belongs to exactly one workspace.
// There is no switching and no second-organization creation anywhere in the
// app (/organization/create only serves users with zero memberships and
// sends existing members back to "/").
